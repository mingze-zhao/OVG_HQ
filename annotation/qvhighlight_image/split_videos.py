...
# 示例用法
input_file = "/mnt/data/jiaqi/online-vg/annotation/qvhighlight_image/highlight_for_generate_all.jsonl"  # 替换为你的输入文件路径
output_prefix = "/mnt/data/jiaqi/online-vg/annotation/qvhighlight_image/split_jsonl_for_generate"  # 输出文件的前缀名

# 调用函数，均分为 8 份并生成新文件和空文件
split_jsonl_file(input_file, output_prefix, n_splits=16)
